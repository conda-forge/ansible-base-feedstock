...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ansible-base-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10896&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ansible-base-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ansible-base` can be installed with:

```
conda install ansible-base
```

It is possible to list all of the versions of `ansible-base` available on your platform with:
